...
const {createQuery,updateQuery,getQuerybyId ,deleteQuery,markResolved,postComment,voteComment,getQuery,updateComment,deleteComment} = require("../controllers/query");
